...
const SubCategories = () => {
    ...
    const onFeaturedChange = async ({ id, value }) => {
        const result = await subCategoriesRest.boolean({
            id,
            field: "featured",
            value,
        });
    ...
    return (
        <>
            ...
            <Modal
                modalRef={modalRef}
                title={
                    isEditing ? "Editar sub categoría" : "Agregar sub categoría"
                }
...
CreateReactScript((el, properties) => {
    createRoot(el).render(
        <BaseAdminto {...properties} title="Sub Categorías">
