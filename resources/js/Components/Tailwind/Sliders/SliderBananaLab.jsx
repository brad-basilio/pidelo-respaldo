...
const SliderBananaLab = ({ items, data }) => {
    ...
    return (
        <div className="px-primary mx-auto my-6 font-paragraph relative 2xl:px-0 2xl:max-w-7xl">
                    ...
                    <SwiperSlide key={index}>
                        ...
                        >
                            <img
                                ...
                                alt={item.name}
                                loading="lazy"
                                className="absolute bottom-0 rotate-180  left-0  h-full lg:top-0 lg:right-0 lg:rotate-0 "
                            />
                            ...
                            <div className="p-5 py-8 lg:max-w-2xl lg:px-16 lg:flex lg:items-center lg:h-full">
                                <div className="flex flex-col gap-5 lg:gap-5 items-start">
                                    ...
                                    <a
                                        ...
                                        className="bg-primary my-1 w-7/12 h-11 flex items-center justify-center rounded-full text-white text-sm font-semibold lg:w-max lg:px-10 "
                                    >
                                        {item.button_text}
                                    </a>
                                </div>
            ...
            <div className="absolute bottom-4 z-50 left-1/2 -translate-x-1/2 flex justify-center gap-2 mt-10">
                {items.map((_, index) => (
                    <button
                        key={index}
