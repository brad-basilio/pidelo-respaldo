  ...
  const getHeader = () => {
    switch (which) {
      ...
      case 'HeaderSearchMenu':
        return <HeaderSearchMenu data={data} items={items} cart={cart} setCart={setCart} pages={pages} isUser={isUser} />
      case 'HeaderScraping':
        return <HeaderScraping data={data} items={items} cart={cart} setCart={setCart} pages={pages} isUser={isUser} />
      default:
