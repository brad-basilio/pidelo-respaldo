...
const FooterSalaFabulosa = ({ pages, generals }) => {
    ...
    return (
        <footer className="bg-primary text-white py-12  text-sm font-font-secondary">
            <div className="px-primary mx-auto grid grid-cols-1 md:grid-cols-6 gap-12">

                {/* Menu Columns */}
                <div className="grid grid-cols-3 gap-8 col-span-4 justify-between mr-6">
                    {/* Logo Column */}
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-white">
                            ...
                            <li>
                                <a onClick={() => openModal(2)} className="cursor-pointer hover:customtext-primary hover:font-bold transition-all duration-300">
                                    Políticas de cambio
                                </a>
                            </li>
                            <li>
                ...
                <div className="col-span-2">
                    <h3 className="customtext-primary font-bold mb-4 text-base ">Únete a nuestro blog</h3>
                    <p className="mb-6 text-white text-sm">Suscríbete y recibe todas nuestras novedades</p>
                    <form onSubmit={onEmailSubmit}>
                        <div className="relative customtext-neutral-dark">
                            <input
                                ...
                                className="w-full customtext-neutral-dark font-semibold  shadow-xl  py-5 pl-5 border rounded-full focus:ring-0 focus:outline-none"
                            />
                            <button
