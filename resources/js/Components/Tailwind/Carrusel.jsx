...
const CarruselBenefitsPideloPe = React.lazy(() =>
    import("./Carrusel/CarruselBenefitsPideloPe")
);
    ...
    const getCarrusel = () => {
        switch (which) {
            case "CarruselBenefitsInifinite":
                ...
                case "CarruselBenefitsPideloPe":
                return <CarruselBenefitsPideloPe data={data} items={items} />;
